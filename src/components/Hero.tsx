export default function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="
        relative mt-[100px] aspect-[4/5] min-h-0 w-full
        overflow-hidden bg-[#F6F3F1]
        md:mt-[116px] md:h-[90vh] md:min-h-[600px] md:aspect-auto
      "
    >
      {/* Banners responsivos */}
...
<div
  className="
    ...
    md:mx-auto md:h-full md:max-w-7xl
    md:items-end md:px-8 md:pb-12
    lg:px-20 lg:pb-16
  "
>
  <button
